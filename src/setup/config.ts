...
export function conf(): RuntimeConfig {
  return {
    ...
    ONBOARDING_CHROME_EXTENSION_INSTALL_LINK: getKey(
      ...
      "https://chromewebstore.google.com/detail/kal-Stream-enchanced/geimjiobahmbkmaigaafjnoanebpmlmj",
    ),
    ONBOARDING_FIREFOX_EXTENSION_INSTALL_LINK: getKey(
      "ONBOARDING_FIREFOX_EXTENSION_INSTALL_LINK",
      "https://addons.mozilla.org/en-US/firefox/addon/kal-Stream-extension-v1/",
    ),
